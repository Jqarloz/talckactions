...
doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "YOU HAS UPDATE YOUR HAMMER.")
doSendMagicEffect(getPlayerPosition(cid), 15)
else
doPlayerSendCancel(cid, "YOU NEED A HAMMER OF PROPHECY!")
doPlayerSendTextMessage(cid, MESSAGE_INFO_DESCR, "YOU NEED A HAMMER OF PROPHECY!")
